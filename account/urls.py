...
from .views import RegistrationView, LoginView, activation_view, ActivationView, UserListView, LogoutView, RegistrationPhoneView, ResetPasswordConfirmView, ResetPasswordConfirmView, ResetPasswordView
